import type { SettingsSerialized, Settings, CodeCamel } from "./newTypes";
import { Modifier } from "obsidian";
import { ModifierKey } from "./newTypes";

export const DEFAULT_SETTINGS: SettingsSerialized = {
	hotkeys: [],
    keybindings: [],
    original: {},
};
...
export const OBSIDIAN_KEY_TO_CHROME_CODE: Record<string, CodeCamel> = Object.entries({
    'ArrowDown': 'ArrowDown',
    'ArrowLeft': 'ArrowLeft',
...
export const OBSIDIAN_MODIFIER_KEYS_MAP: Record<Lowercase<Modifier>, ModifierKey> = {
    'ctrl': 'ctrl',
    'mod': 'alt',
    'shift': 'shift',
    'meta': 'meta',
